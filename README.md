...
- **Lowest RAM, lowest bill** — slim idles **~160 MB** (no dashboard, no Node, no
...
- **Pinned to a real upstream release** — currently
  **[`v2026.8.3`](https://github.com/NousResearch/hermes-agent/releases/tag/v2026.8.3)
  (hermes-agent v0.20.0)**, not a moving `main`, so a deploy today and a deploy next
...
> Tracking hermes-agent **v0.20.0** (upstream tag `v2026.8.3`). Containers are
